...
if __name__ == '__main__':
    ...
    parser.add_argument('--periodogram', action='store_true', help="Run the periodogram analysis")
    parser.add_argument('--genetic_algorithm', action='store_true', help="Run the genetic algorithm fit")
